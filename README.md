...
Real_data.R | Analyzes the ACTG 175 clinical trial data using the hybrid workflow. Implements Stage 1 global heterogeneity testing with STEPP plots for key biomarkers. Performs Stage 2 cross fitted nuisance modeling and causal forest CATE estimation, followed by uplift/AUQC computation, DR policy value curves with threshold selection, and an NP frontier under a specified harm tolerance. | Predicted entities for each task and accuracy measurements. ​​
